...
"""
# Reading of the data
df_train = pd.read_csv("assets/input/train.csv")
df_spray = pd.read_csv("assets/input/spray.csv")
...
temp_mos.update_layout(
    hovermode="x unified", height=500, width=1000, title="Temperature vs Mosquito Count"
)
